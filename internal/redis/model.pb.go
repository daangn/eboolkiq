...
var file_internal_redis_model_proto_rawDesc = []byte{
	...
	0x52, 0x07, 0x73, 0x74, 0x61, 0x72, 0x74, 0x41, 0x74, 0x42, 0x56, 0x0a, 0x1b, 0x63, 0x6f, 0x6d,
...
var file_internal_redis_model_proto_depIdxs = []int32{
	1, // 0: eboolkiq.internal.redis.Working.job:type_name -> eboolkiq.Job
	2, // 1: eboolkiq.internal.redis.Working.queue:type_name -> eboolkiq.Queue
	3, // 2: eboolkiq.internal.redis.Working.start_at:type_name -> google.protobuf.Timestamp
