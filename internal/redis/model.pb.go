...
func (x *Working) GetStartAt() *timestamppb.Timestamp {
	if x != nil {
		return x.StartAt
	}
	return nil
...
var file_internal_redis_model_proto_rawDesc = []byte{
	...
	0x6f, 0x72, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x42, 0x56, 0x0a, 0x1b, 0x63, 0x6f, 0x6d,
	0x2e, 0x65, 0x62, 0x6f, 0x6f, 0x6c, 0x6b, 0x69, 0x71, 0x2e, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e,
	0x61, 0x6c, 0x2e, 0x72, 0x65, 0x64, 0x69, 0x73, 0x42, 0x0a, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x50,
	...
	0x69, 0x71, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x72, 0x65, 0x64, 0x69,
...
var file_internal_redis_model_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_internal_redis_model_proto_goTypes = []interface{}{
	...
	(*pb.Job)(nil),                // 2: eboolkiq.Job
	(*pb.Queue)(nil),              // 3: eboolkiq.Queue
	(*timestamppb.Timestamp)(nil), // 4: google.protobuf.Timestamp
}
var file_internal_redis_model_proto_depIdxs = []int32{
	2, // 0: eboolkiq.internal.redis.Working.job:type_name -> eboolkiq.Job
	3, // 1: eboolkiq.internal.redis.Working.queue:type_name -> eboolkiq.Queue
	4, // 2: eboolkiq.internal.redis.Working.start_at:type_name -> google.protobuf.Timestamp
	2, // 3: eboolkiq.internal.redis.Failed.job:type_name -> eboolkiq.Job
